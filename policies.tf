...
resource "spacelift_policy" "accesspolicy" {
  type = "ACCESS"
...
resource "spacelift_policy_attachment" "access" {
  policy_id = spacelift_policy.accesspolicy.id
...
resource "spacelift_policy" "planpolicy" {
  type = "PLAN"
...
resource "spacelift_policy_attachment" "plan" {
  policy_id = spacelift_policy.planpolicy.id
  stack_id  = spacelift_stack.managed.id
}
...
resource "spacelift_policy" "pushpolicy" {
  type = "GIT_PUSH"
...
resource "spacelift_policy_attachment" "push" {
  policy_id = spacelift_policy.pushpolicy.id
  stack_id  = spacelift_stack.managed.id
}
...
resource "spacelift_policy" "taskpolicy" {
  type = "TASK"
...
resource "spacelift_policy_attachment" "task" {
  policy_id = spacelift_policy.taskpolicy.id
  stack_id  = spacelift_stack.managed.id
}
...
resource "spacelift_policy" "triggerpolicy" {
  type = "TRIGGER"
...
resource "spacelift_policy_attachment" "trigger" {
  policy_id = spacelift_policy.triggerpolicy.id
  stack_id  = spacelift_stack.managed.id
}
...
resource "spacelift_policy" "loginpolicy" {
  type = "LOGIN"
